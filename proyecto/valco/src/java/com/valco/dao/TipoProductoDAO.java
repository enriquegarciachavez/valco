...
public class TipoProductoDAO {
    ...
    public void insertarTipoProducto(TipoProductoDAO tipoproducto) throws Exception {
     ...
     public void actualizarTipoProducto(TipoProductoDAO tipoProducto) throws Exception {
        Session session = HibernateUtil.getSessionFactory().getCurrentSession();
        Transaction tx = null;
        try {
            tx = session.beginTransaction();
      ...
      public void borrarTipoProducto(TipoProductoDAO tipoProducto) throws Exception {
        Session session = HibernateUtil.getSessionFactory().getCurrentSession();
        Transaction tx = null;
        try {
            tx = session.beginTransaction();
